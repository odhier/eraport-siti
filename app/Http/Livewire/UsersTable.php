...
{
    protected $listeners = ['confirmDelete', 'handleDelete', 'successMessage', 'errorMessage', 'editForm'];
    ...
    public function columns()
    {
        return [
            ...
            Column::callback(['paraf_img', 'id'], function ($paraf, $id) {
                return view('livewire.datatables.paraf', ['paraf' => $paraf, 'id' => $id]);
            })->label('Paraf'),
            ...
            Column::callback(['id', 'name', 'role_id'], function ($id, $name, $role_id) {
                ...
                <a data-toggle="modal" data-target="#editModal" wire:click="$emitTo(\'pages.admin\',\'editForm\',\'' . $id . '\')" class="p-1 text-blue-600 hover:bg-blue-600 hover:text-white rounded">
